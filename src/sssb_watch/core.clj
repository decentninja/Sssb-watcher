...
(def AREAS-OF-INTEREST ["Roslagstull" "Nyponet" "Forum" "Domus" "Mjölner" "Flemingsberg"])
...
(defn -main
  [& args]
  (show-objects (filter-interesting (parse-n-extract (download-data SEARCH-URL))
                                    AREAS-OF-INTEREST)))
